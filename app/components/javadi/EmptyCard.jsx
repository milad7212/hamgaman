...
function EmptyCard({ children,whichIndex }) {
  return (
    <div className="my-8 m-4 border  relative border-dashed border-gray-400 rounded-md h-28 hover:shadow-xl duration-200 ease-in cursor-pointer hover:border-solid">
      ...
      <AiOutlineDelete className="text-gray-800 hover:text-red-500 hover:scale-125 duration-150 ease-in"/>
      </div>

      <div className=" left-0 right-0 flex justify-center absolute -top-3">
        <BsPlusCircle onClick={()=>alert(whichIndex)}  size={25} className="text-gray-400 hover:text-gray-700" />
      </div>
